...
#define writew_relaxed(v, c)	((void)__arch_putw((__force u16) \
						    cpu_to_le16(v), (c)))
#define writel_relaxed(v, c)	((void)__arch_putl((__force u32) \
						    cpu_to_le32(v), (c)))
#define writeq_relaxed(v, c)	((void)__arch_putq((__force u64) \
						    cpu_to_le64(v), (c)))
